\chapter{Benchmarking model for sensors in smart environments} 
\label{ch:benchmark}
...
The rating of the different technologies and the resulting score is shown in Table \ref{tab:bench_feature_rating}.
