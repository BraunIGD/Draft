...
\captionof{figure}{Screenshot of the Capacitive Chair application showing the fitted 3D model on the left and detected posture on the right}
...
\captionof{figure}{Screenshot of the Capacitive Chair application showing the sensor values on the left and FFT analysis of various sensors on the right}
