...
\captionof{figure}{MagicBox sketch - six electrodes uniformly distributed below surface}
...
\captionof{figure}{MagicBox conceptual rendering (left) and detail view of electronics (right) \cite{Braun2011MultiInputDevice}}
...
\captionof{figure}{MagicBox demonstration application - 3D object viewer (left) and image viewer (right) \cite{Braun2011MultiInputDevice}}
...
\captionof{figure}{Gesture overview module (left) and gesture recorder (right) \cite{braun2013capacitive}}
